...
entry:
  ...
  ;  Source: whatIsBigger(154.55,180)
  %".3" = sitofp i32 180 to float
  %".4" = call float @"whatIsBigger"(float 0x40635199a0000000, float %".3")
  ;  Source: floatbiggest=whatIsBigger(154.55,180);
  store float %".4", float* %"biggest"
