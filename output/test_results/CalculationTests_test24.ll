...
entry:
  ...
  ;  Source: *ptr
  %"deref_load.1" = load i32, i32* %"ptr_load.3"
  ;  Source: printf("%d ",*ptr);
  ...
  %".32" = ptrtoint i32* %"ptr_load.5" to i32
  ...
  %".42" = ptrtoint i32* %"ptr_load.6" to i32
  ...
  ;  Source: ptr2>=ptr;
  %".52" = ptrtoint float* %"ptr2_load" to i32
  %".53" = ptrtoint i32* %"ptr_load.7" to i32
  ...
  ;  Source: ptr2<=ptr;
  %".59" = ptrtoint float* %"ptr2_load.1" to i32
  ...
  ;  Source: ptr>&x;
  %".66" = ptrtoint i32* %"ptr_load.9" to i32
  ...
  ;  Source: ptr<32;
  %".72" = ptrtoint i32* %"ptr_load.10" to i32
