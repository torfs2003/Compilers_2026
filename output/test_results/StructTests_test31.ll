...
entry:
  ...
  %".24" = load %"struct.kaas"*, %"struct.kaas"** %"gep_kaas_ptr.2"
  %"gep_melk.2" = getelementptr inbounds %"struct.kaas", %"struct.kaas"* %".24", i32 0, i32 0
  %"load_melk.2" = load i32, i32* %"gep_melk.2"
  ;  Source: printf("%d",ptr2->kaas_ptr->melk);
  %".26" = call i32 (i8*, ...) @"printf"(i8* %".21", i32 %"load_melk.2")
  ;  Source: return0;
  ret i32 0
}
