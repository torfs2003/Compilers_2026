...
entry:
  ...
  ;  Source: (ptr==&x)
  %".20" = ptrtoint i32* %"ptr_load.2" to i32
  ...
  ;  Source: (ptr==&y)
  %".30" = ptrtoint i32* %"ptr_load.3" to i32
  ...
  %".41" = ptrtoint i32* %"ptr_load.4" to i32
  ...
  ;  Source: ptr2>=ptr;
  %".49" = ptrtoint float* %"ptr2_load" to i32
  %".50" = ptrtoint i32* %"ptr_load.5" to i32
  ...
  ;  Source: ptr2<=ptr;
  %".56" = ptrtoint float* %"ptr2_load.1" to i32
  %".57" = ptrtoint i32* %"ptr_load.6" to i32
  ...
  ;  Source: ptr>&x;
  %".63" = ptrtoint i32* %"ptr_load.7" to i32
  ...
  ;  Source: ptr<32;
  %".69" = ptrtoint i32* %"ptr_load.8" to i32
  ...
  %".75" = mul i32 4, %"num_skip_elements_load"
  ;  Source: ptr+4*num_skip_elements
  %".77" = getelementptr i32, i32* %"ptr_load.10", i32 %".75"
