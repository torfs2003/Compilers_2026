...
entry:
  ...
  %".38" = call i32 (i8*, ...) @"printf"(i8* %".34", i32 %"deref_load.6")
  %"z" = alloca i32
  ;  Source: integer
  %"integer.3" = load i32, i32* %"integer"
  ;  Source: integer+5
  %".41" = add i32 %"integer.3", 5
  ...
  %"z.1" = load i32, i32* %"z"
  ;  Source: printf("%d",z);
  %".47" = call i32 (i8*, ...) @"printf"(i8* %".44", i32 %"z.1")
  ;  Source: int_ptr
  ...
  %".53" = bitcast [3 x i8]* @"str.6" to i8*
  ;  Source: int_ptr
  %"int_ptr.4" = load i32*, i32** %"int_ptr"
  ;  Source: *int_ptr
  %"deref_load.7" = load i32, i32* %"int_ptr.4"
  ;  Source: printf("%d",*int_ptr);
  %".57" = call i32 (i8*, ...) @"printf"(i8* %".53", i32 %"deref_load.7")
  %"pointer" = alloca i32*
  ;  Source: z
  %"z.3" = load i32, i32* %"z"
  ;  Source: &z
  ...
  %".71" = bitcast [3 x i8]* @"str.8" to i8*
  ;  Source: x
  %"x.1" = load i32, i32* %"x"
  ;  Source: printf("%d",x);
  %".74" = call i32 (i8*, ...) @"printf"(i8* %".71", i32 %"x.1")
  %"x_ptr" = alloca i32**
  ;  Source: int_ptr
  ...
  %".83" = call i32 (i8*, ...) @"printf"(i8* %".79", i32 %"deref_load.11")
  ;  Source: return0;
  ret i32 0
}
