...
entry:
  ...
  %".6" = call i32 (i8*, ...) @"printf"(i8* %".3", i32 %"integer_load")
  %"int_ptr" = alloca i32*
  ...
  ;  Source: ptr_ptr
  %"ptr_ptr_load.2" = load i32**, i32*** %"ptr_ptr"
  %"deref_load.3" = load i32*, i32** %"ptr_ptr_load.2"
  ;  Source: **ptr_ptr
  ...
  %"deref_load.5" = load i32*, i32** %"another_pointer_load"
  ;  Source: **another_pointer
  ...
  %".30" = add i32 %"integer_load.1", 5
  store i32 %".30", i32* %"z"
  %".32" = bitcast [3 x i8]* @"str.5" to i8*
  ;  Source: z
  %"z_load" = load i32, i32* %"z"
  ;  Source: printf("%d",z);
  %".35" = call i32 (i8*, ...) @"printf"(i8* %".32", i32 %"z_load")
  ;  Source: int_ptr
  ...
  ;  Source: *int_ptr
  %"deref_load.7" = load i32, i32* %"int_ptr_load.2"
  ;  Source: printf("%d",*int_ptr);
