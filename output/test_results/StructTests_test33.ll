...
entry:
  ...
  ;  Source: gouda.appel
  %"gep_appel" = getelementptr inbounds %"struct.kaas", %"struct.kaas"* %"gouda", i32 0, i32 0
  %"load_appel" = load i32, i32* %"gep_appel"
  ;  Source: gouda.appel=1;
  store i32 1, i32* %"gep_appel"
  ;  Source: return0;
  ret i32 0
}
...
entry:
  ...
  %"gep_melk.1" = getelementptr inbounds %"struct.kaas", %"struct.kaas"* %"load_kaas_ptr.1", i32 0, i32 0
  %"load_melk.1" = load i32, i32* %"gep_melk.1"
  ;  Source: printf("%d",(*ptr.kaas_ptr).melk);
  %".13" = call i32 (i8*, ...) @"printf"(i8* %".10", i32 %"load_melk.1")
  ;  Source: lol();
  %".15" = call i32 @"lol"()
  ;  Source: return0;
  ret i32 0
