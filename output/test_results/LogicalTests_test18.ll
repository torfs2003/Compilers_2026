...
entry:
  ...
  ;  Source: (d&&5<6)
  %".15" = icmp ne i32 %"d_load", 0
  %".16" = icmp ne i32 1, 0
  %".17" = and i1 %".15", %".16"
  %".18" = zext i1 %".17" to i32
  %".19" = icmp ne i32 %"e_load", 0
  %".20" = icmp ne i32 %".18", 0
  %".21" = and i1 %".19", %".20"
  %".22" = zext i1 %".21" to i32
  ;  Source: (a||e&&(d&&5<6))
  %".24" = icmp ne i32 %"a_load", 0
  %".25" = icmp ne i32 %".22", 0
  %".26" = or i1 %".24", %".25"
  ...
  ;  Source: printf("%d",f);
  %".36" = call i32 (i8*, ...) @"printf"(i8* %".33", i32 %"f_load.1")
  ;  Source: g
  ...
  %".40" = icmp slt i32 %"a_load.1", %"d_load.1"
  %".41" = zext i1 %".40" to i32
  ;  Source: e
  %"e_load.1" = load i32, i32* %"e"
  ;  Source: b
  %"b_load" = load i32, i32* %"b"
  %".44" = icmp sge i32 %"e_load.1", %"b_load"
  ...
  ;  Source: printf("%d",g);
  %".56" = call i32 (i8*, ...) @"printf"(i8* %".53", i32 %"g_load.1")
  ;  Source: h
  ...
  %".60" = sub i32 %"a_load.2", %"b_load.1"
  ;  Source: d
  %"d_load.2" = load i32, i32* %"d"
  %".62" = icmp slt i32 %".60", %"d_load.2"
  ...
  ;  Source: (e>g)
  %".67" = icmp sgt i32 %"e_load.2", %"g_load.2"
  ...
  ;  Source: printf("%d",h);
  %".82" = call i32 (i8*, ...) @"printf"(i8* %".79", i32 %"h_load.1")
  ;  Source: return0;
  ret i32 0
}
