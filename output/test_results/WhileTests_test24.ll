...
while.body:
  ...
  store i32 %"i_load.2", i32* %"b"
  %".11" = bitcast [3 x i8]* @"str" to i8*
  %"b_load" = load i32, i32* %"b"
  %".12" = call i32 (i8*, ...) @"printf"(i8* %".11", i32 %"b_load")
...
while.body.1:
  ...
  %".26" = call i32 (i8*, ...) @"printf"(i8* %".25", i32 %"a_load.2")
  br label %"while.cond.1"
while.end.1:
