...
if.then:
  ...
  %".22" = icmp slt i32 %"b_load.1", %"c_load.1"
...
if.else.1:
  ...
  %".28" = icmp sgt i32 %"b_load.2", %"d_load.1"
...
if.else.2:
  ...
  %"ifcond.6" = icmp ne i32 %"c_load.3", 0
...
if.else.3:
  ...
  %"ifcond.5" = icmp ne i32 %"d_load.2", 0
...
if.then.6:
  ...
  %".52" = icmp slt i32 %"a_load.2", %"b_load.4"
...
if.else.4:
  ...
  %"ifcond.8" = icmp ne i32 %"d_load.3", 0
...
if.then.8:
  ...
  %"ifcond.9" = icmp ne i32 %"d_load.4", 0
...
if.then.10:
  ...
  %".90" = icmp slt i32 %"b_load.6", %"c_load.5"
...
if.else.7:
  ...
  %".96" = icmp sgt i32 %"b_load.7", %"d_load.6"
...
if.else.8:
  ...
  %"ifcond.16" = icmp ne i32 %"c_load.7", 0
...
if.else.9:
  ...
  %"ifcond.15" = icmp ne i32 %"d_load.7", 0
...
if.then.16:
  ...
  %".120" = icmp slt i32 %"a_load.5", %"b_load.9"
...
if.else.10:
  ...
  %"ifcond.18" = icmp ne i32 %"d_load.8", 0
...
if.then.18:
  ...
  %"ifcond.19" = icmp ne i32 %"d_load.9", 0
...
if.then.20:
  ...
  %".158" = icmp slt i32 %"b_load.11", %"c_load.9"
...
if.else.13:
  ...
  %".164" = icmp sgt i32 %"b_load.12", %"d_load.11"
...
if.else.14:
  ...
  %"ifcond.26" = icmp ne i32 %"c_load.11", 0
...
if.else.15:
  ...
  %"ifcond.25" = icmp ne i32 %"d_load.12", 0
...
if.then.26:
  ...
  %".188" = icmp slt i32 %"a_load.8", %"b_load.14"
...
if.else.16:
  ...
  %"ifcond.28" = icmp ne i32 %"d_load.13", 0
...
if.then.28:
  ...
  %"ifcond.29" = icmp ne i32 %"d_load.14", 0
...
if.then.30:
  ...
  %".226" = icmp slt i32 %"b_load.16", %"c_load.13"
...
if.else.19:
  ...
  %"d_load.16" = load i32, i32* %"d"
  %".232" = icmp sgt i32 %"b_load.17", %"d_load.16"
...
if.else.20:
  ...
  %"ifcond.36" = icmp ne i32 %"c_load.15", 0
...
if.end.34:
  ...
  br label %"if.end.33"
if.else.21:
  %"d_load.17" = load i32, i32* %"d"
  %"ifcond.35" = icmp ne i32 %"d_load.17", 0
...
if.then.36:
  ...
  %".256" = icmp slt i32 %"a_load.11", %"b_load.19"
...
if.end.36:
  br label %"if.end.33"
if.else.22:
  %"d_load.18" = load i32, i32* %"d"
  %"ifcond.38" = icmp ne i32 %"d_load.18", 0
...
if.then.38:
  ...
  %"d_load.19" = load i32, i32* %"d"
  %"ifcond.39" = icmp ne i32 %"d_load.19", 0
...
if.then.40:
  ...
  %".294" = icmp slt i32 %"b_load.21", %"c_load.17"
...
if.else.24:
  ...
  %"ifcond.43" = icmp ne i32 %"b_load.23", 0
...
if.else.25:
  ...
  %"d_load.21" = load i32, i32* %"d"
  %".300" = icmp sgt i32 %"b_load.22", %"d_load.21"
...
if.else.26:
  ...
  %"ifcond.46" = icmp ne i32 %"c_load.19", 0
...
if.end.44:
  ...
  br label %"if.end.43"
if.else.27:
  %"d_load.22" = load i32, i32* %"d"
  %"ifcond.45" = icmp ne i32 %"d_load.22", 0
...
if.then.46:
  ...
  %"b_load.24" = load i32, i32* %"b"
  %".324" = icmp slt i32 %"a_load.14", %"b_load.24"
...
if.end.46:
  br label %"if.end.43"
if.else.28:
  %"d_load.23" = load i32, i32* %"d"
  %"ifcond.48" = icmp ne i32 %"d_load.23", 0
...
if.then.48:
  ...
  %"d_load.24" = load i32, i32* %"d"
  %"ifcond.49" = icmp ne i32 %"d_load.24", 0
