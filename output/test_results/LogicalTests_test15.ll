...
entry:
  ...
  ;  Source: (b||c)
  %".149" = icmp ne i32 %"b_load.7", 0
  %".150" = icmp ne i32 %"c_load.4", 0
  %".151" = or i1 %".149", %".150"
  %".152" = zext i1 %".151" to i32
  %".153" = icmp eq i32 %".152", 0
  %".154" = zext i1 %".153" to i32
  %".155" = icmp ne i32 %"a_load.7", 0
  ...
  %".161" = icmp eq i32 %"d_load.4", 0
  %".162" = zext i1 %".161" to i32
  ;  Source: (b&&!d)
  %".164" = icmp ne i32 %"b_load.8", 0
  ...
  ;  Source: printf("%d",f);
  %".180" = call i32 (i8*, ...) @"printf"(i8* %".177", i32 %"f_load.7")
  ;  Source: a
  ...
  ;  Source: (b||c)
  %".192" = icmp ne i32 %"b_load.10", 0
  %".193" = icmp ne i32 %"c_load.5", 0
  %".194" = or i1 %".192", %".193"
  %".195" = zext i1 %".194" to i32
  %".196" = icmp eq i32 %".195", 0
  %".197" = zext i1 %".196" to i32
  %".198" = icmp ne i32 %"a_load.9", 0
  ...
  %".204" = icmp eq i32 %"d_load.5", 0
  %".205" = zext i1 %".204" to i32
  ;  Source: (b&&!d)
  %".207" = icmp ne i32 %"b_load.11", 0
  ...
  ;  Source: printf("%d",f);
  %".223" = call i32 (i8*, ...) @"printf"(i8* %".220", i32 %"f_load.9")
  ;  Source: a
  ...
  ;  Source: (b||c)
  %".238" = icmp ne i32 %"b_load.13", 0
  %".239" = icmp ne i32 %"c_load.7", 0
  %".240" = or i1 %".238", %".239"
  %".241" = zext i1 %".240" to i32
  %".242" = icmp eq i32 %".241", 0
  %".243" = zext i1 %".242" to i32
  %".244" = icmp ne i32 %"a_load.11", 0
  ...
  %".250" = icmp eq i32 %"d_load.6", 0
  %".251" = zext i1 %".250" to i32
  ;  Source: (b&&!d)
  %".253" = icmp ne i32 %"b_load.14", 0
  ...
  ;  Source: printf("%d",f);
  %".269" = call i32 (i8*, ...) @"printf"(i8* %".266", i32 %"f_load.11")
  ;  Source: a
  ...
  ;  Source: (b||c)
  %".284" = icmp ne i32 %"b_load.16", 0
  %".285" = icmp ne i32 %"c_load.9", 0
  %".286" = or i1 %".284", %".285"
  %".287" = zext i1 %".286" to i32
  %".288" = icmp eq i32 %".287", 0
  %".289" = zext i1 %".288" to i32
  %".290" = icmp ne i32 %"a_load.13", 0
  ...
  %".296" = icmp eq i32 %"d_load.7", 0
  %".297" = zext i1 %".296" to i32
  ;  Source: (b&&!d)
  %".299" = icmp ne i32 %"b_load.17", 0
  ...
  ;  Source: printf("%d",f);
  %".315" = call i32 (i8*, ...) @"printf"(i8* %".312", i32 %"f_load.13")
  ;  Source: a
  ...
  ;  Source: (b||c)
  %".330" = icmp ne i32 %"b_load.19", 0
  %".331" = icmp ne i32 %"c_load.11", 0
  %".332" = or i1 %".330", %".331"
  %".333" = zext i1 %".332" to i32
  %".334" = icmp eq i32 %".333", 0
  %".335" = zext i1 %".334" to i32
  %".336" = icmp ne i32 %"a_load.15", 0
  ...
  %".342" = icmp eq i32 %"d_load.8", 0
  %".343" = zext i1 %".342" to i32
  ;  Source: (b&&!d)
  %".345" = icmp ne i32 %"b_load.20", 0
  ...
  ;  Source: printf("%d",f);
  %".361" = call i32 (i8*, ...) @"printf"(i8* %".358", i32 %"f_load.15")
  ;  Source: a
  ...
  ;  Source: (b||c)
  %".376" = icmp ne i32 %"b_load.22", 0
  %".377" = icmp ne i32 %"c_load.13", 0
  %".378" = or i1 %".376", %".377"
  %".379" = zext i1 %".378" to i32
  %".380" = icmp eq i32 %".379", 0
  %".381" = zext i1 %".380" to i32
  %".382" = icmp ne i32 %"a_load.17", 0
  ...
  %".388" = icmp eq i32 %"d_load.9", 0
  %".389" = zext i1 %".388" to i32
  ;  Source: (b&&!d)
  %".391" = icmp ne i32 %"b_load.23", 0
  ...
  ;  Source: printf("%d",f);
  %".407" = call i32 (i8*, ...) @"printf"(i8* %".404", i32 %"f_load.17")
  ;  Source: return0;
  ret i32 0
}
