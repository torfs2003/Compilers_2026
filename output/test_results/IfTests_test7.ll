...
if.end:
  ...
  %".26" = icmp ne i32 %"a_load.3", 0
  %".27" = icmp ne i32 %"b_load.3", 0
  %".28" = and i1 %".26", %".27"
...
if.end.1:
  ...
  %".41" = icmp ne i32 %"a_load.5", 0
  %".42" = icmp ne i32 %"b_load.5", 0
  %".43" = and i1 %".41", %".42"
...
if.end.2:
  ...
  %".56" = icmp ne i32 %"a_load.7", 0
  %".57" = icmp ne i32 %"b_load.7", 0
  %".58" = and i1 %".56", %".57"
