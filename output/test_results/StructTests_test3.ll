...
entry:
  ...
  ;  Source: beemster.melk=12;
  store i32 12, i32* %"gep_melk.4"
  ;  Source: beemster.fermtented
  %"gep_fermtented.4" = getelementptr inbounds %"struct.kaas2", %"struct.kaas2"* %"beemster", i32 0, i32 1
