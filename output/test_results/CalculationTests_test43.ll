...
entry:
  ...
  ;  Source: ia+ia;
  %".16" = add i32 %"ia.1", %"ia.2"
  ;  Source: ia
  %"ia.3" = load i32, i32* %"ia"
  ;  Source: sa
  %"sa.1" = load i32*, i32** %"sa"
  ;  Source: ia+sa;
  %".20" = getelementptr i32, i32* %"sa.1", i32 %"ia.3"
  ;  Source: sa
  %"sa.2" = load i32*, i32** %"sa"
  ;  Source: ia
  %"ia.4" = load i32, i32* %"ia"
  ;  Source: sa+ia;
  %".24" = getelementptr i32, i32* %"sa.2", i32 %"ia.4"
  ;  Source: ia
  %"ia.5" = load i32, i32* %"ia"
  ;  Source: ia
  %"ia.6" = load i32, i32* %"ia"
  ;  Source: ia-ia;
  %".28" = sub i32 %"ia.5", %"ia.6"
  %"sa.3" = alloca i32*
  ;  User Comment: //int b = sa * ia; // Not allowed OK
  ;  Source: ia
