...
entry:
  ...
  %"b" = alloca i32*
  %"a.6" = load i32*, i32** %"a"
  %".34" = bitcast i32* %"a.6" to i8*
  %".35" = call i8* @"realloc"(i8* %".34", i32 100)
  %".36" = bitcast i8* %".35" to i32*
  store i32* %".36", i32** %"b"
  ;  Source: b
  %"b.1" = load i32*, i32** %"b"
  ;  Source: (b+20)
  %".40" = getelementptr i32, i32* %"b.1", i32 20
  %"deref_load.5" = load i32, i32* %".40"
  ;  Source: *(b+20)=89;
  store i32 89, i32* %".40"
  ...
  %"b.2" = load i32*, i32** %"b"
  ;  Source: (b+20)
  %".46" = getelementptr i32, i32* %"b.2", i32 20
  ;  Source: *(b+20)
  %"deref_load.6" = load i32, i32* %".46"
  ;  Source: printf("%d",*(b+20));
  %".49" = call i32 (i8*, ...) @"printf"(i8* %".43", i32 %"deref_load.6")
  ;  Source: return0;
  ret i32 0
}
