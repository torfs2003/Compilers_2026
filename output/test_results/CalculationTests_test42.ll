...
entry:
  ...
  ;  Source: sa
  %"sa_load.2" = load i32*, i32** %"sa"
  ;  Source: ia
  %"ia_load.6" = load i32, i32* %"ia"
  ;  Source: sa-ia;
  %".33" = sub i32 0, %"ia_load.6"
  %".34" = getelementptr i32, i32* %"sa_load.2", i32 %".33"
  ;  Source: ia
  %"ia_load.7" = load i32, i32* %"ia"
  ;  Source: ia
  %"ia_load.8" = load i32, i32* %"ia"
  ;  Source: ia/ia;
  %".38" = sdiv i32 %"ia_load.7", %"ia_load.8"
  ;  Source: ia
  %"ia_load.9" = load i32, i32* %"ia"
  ;  Source: ia
  %"ia_load.10" = load i32, i32* %"ia"
  ;  Source: ia%ia;
  %".42" = srem i32 %"ia_load.9", %"ia_load.10"
  ;  Source: return0;
  ret i32 0
}
