...
entry:
  ...
  ;  Source: *f_ptr
  %"deref_load" = load float, float* %"f_ptr_load"
  ...
  ;  Source: f
  ;  Source: printf("%f",f);
  %".13" = fpext float 0x3fe93f7ce0000000 to double
  %".14" = call i32 (i8*, ...) @"printf"(i8* %".10", double %".13")
  %"non_const_f_ptr" = alloca float*
  %"f_ptr_load.1" = load float*, float** %"f_ptr"
  store float* %"f_ptr_load.1", float** %"non_const_f_ptr"
  %".16" = bitcast [3 x i8]* @"str.2" to i8*
  ;  Source: non_const_f_ptr
  %"non_const_f_ptr_load" = load float*, float** %"non_const_f_ptr"
  ;  Source: *non_const_f_ptr
  %"deref_load.1" = load float, float* %"non_const_f_ptr_load"
  ;  Source: printf("%f",*non_const_f_ptr);
  %".20" = fpext float %"deref_load.1" to double
  %".21" = call i32 (i8*, ...) @"printf"(i8* %".16", double %".20")
  ;  Source: non_const_f_ptr
  %"non_const_f_ptr_load.1" = load float*, float** %"non_const_f_ptr"
  %"deref_load.2" = load float, float* %"non_const_f_ptr_load.1"
  ;  Source: *non_const_f_ptr=3.1492;
  store float 0x4009318fc0000000, float* %"non_const_f_ptr_load.1"
  %".25" = bitcast [3 x i8]* @"str.3" to i8*
  ;  Source: non_const_f_ptr
  %"non_const_f_ptr_load.2" = load float*, float** %"non_const_f_ptr"
  ;  Source: *non_const_f_ptr
  %"deref_load.3" = load float, float* %"non_const_f_ptr_load.2"
  ;  Source: printf("%f",*non_const_f_ptr);
  ...
  ;  Source: f
  ;  Source: printf("%f",f);
  %".34" = fpext float 0x3fe93f7ce0000000 to double
