...
entry:
  ...
  %"gep_idx" = getelementptr i32, i32* %"decay_left", i32 1
  %"array_element" = load i32, i32* %"gep_idx"
  ;  Source: c[1]=0;
  store i32 0, i32* %"gep_idx"
  ...
  %"gep_idx.4" = getelementptr i32, i32* %"decay_left.4", i32 3
  ...
  %"gep_idx.5" = getelementptr i32, i32* %"decay_left.5", i32 4
