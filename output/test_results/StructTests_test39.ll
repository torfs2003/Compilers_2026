...
entry:
  ...
  ;  Source: printf("gouda.as_integer: %c",gouda.as_integer);
  %".12" = call i32 (i8*, ...) @"printf"(i8* %".9", i32 %"load_as_integer.1")
  ;  Source: return0;
  ret i32 0
}

@"str" = internal constant [21 x i8] c"gouda.as_integer: %c\00"