...
while.cond:
  ...
  %"range_load" = load i32, i32* %"range"
  %".8" = icmp sle i32 %"i_load", %"range_load"
  %".9" = zext i1 %".8" to i32
  %"whilecond" = icmp ne i32 %".9", 0
  br i1 %"whilecond", label %"while.body", label %"while.end"
while.body:
  %"i_load.1" = load i32, i32* %"i"
  %"toCheck_load" = load i32, i32* %"toCheck"
  %".11" = icmp eq i32 %"i_load.1", %"toCheck_load"
...
entry:
  ...
  ;  Source: boolean
  %"boolean_load" = load i32, i32* %"boolean"
  ;  Source: printf("%d",boolean);
  %".7" = call i32 (i8*, ...) @"printf"(i8* %".4", i32 %"boolean_load")
  ;  Source: return0;
  ret i32 0
}
