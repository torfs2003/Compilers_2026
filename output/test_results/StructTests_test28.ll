...
entry:
  ...
  ;  Source: printf("%f\n",gouda.yoghurt);
  %".11" = fpext float %"load_yoghurt.1" to double
  ...
  ;  Source: gouda.melk
  %"gep_melk.3" = getelementptr inbounds %"union.kaas", %"union.kaas"* %"gouda", i32 0, i32 0
  %"load_melk.3" = load i32, i32* %"gep_melk.3"
  ;  Source: printf("%d\n",gouda.melk);
  %".23" = call i32 (i8*, ...) @"printf"(i8* %".20", i32 %"load_melk.3")
  ;  Source: return0;
  ret i32 0
}
