...
entry:
  ...
  ;  Source: s[1]=101;
  %".30" = trunc i32 101 to i8
  store i8 %".30", i8* %"gep_array.1"
  ...
  %"str" = alloca i8*
  %".37" = bitcast [10 x i8]* @"str.2" to i8*
  store i8* %".37", i8** %"str"
  %".39" = bitcast [3 x i8]* @"str.3" to i8*
  ;  Source: str
  %"str_load" = load i8*, i8** %"str"
  ;  Source: printf("%s",str);
  %".42" = call i32 (i8*, ...) @"printf"(i8* %".39", i8* %"str_load")
  ;  Source: return0;
  ret i32 0
}
...
@"str.2" = internal constant [10 x i8] c"string he\00"
@"str.3" = internal constant [3 x i8] c"%s\00"