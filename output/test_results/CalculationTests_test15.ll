...
entry:
  ...
  %".25" = call i32 (i8*, ...) @"printf"(i8* %".21", i32 %"deref_load")
  %"ptr_ptr" = alloca i32**
  ;  Source: int_ptr
  ...
  %".34" = call i32 (i8*, ...) @"printf"(i8* %".30", i32 %"deref_load.2")
  ...
  %".42" = call i32 (i8*, ...) @"printf"(i8* %".38", i32 %"deref_load.4")
  %"z" = alloca i32
  ;  Source: integer
  %"integer.5" = load i32, i32* %"integer"
  ;  Source: integer+5
  %".45" = add i32 %"integer.5", 5
  ...
  %"z.1" = load i32, i32* %"z"
  ;  Source: printf("%d",z);
  %".51" = call i32 (i8*, ...) @"printf"(i8* %".48", i32 %"z.1")
  ;  Source: int_ptr
  ...
  ;  Source: printf("%d",*int_ptr);
  %".61" = call i32 (i8*, ...) @"printf"(i8* %".57", i32 %"deref_load.5")
  %"pointer" = alloca i32*
  ;  Source: z
  %"z.3" = load i32, i32* %"z"
  ;  Source: &z
  ...
  %"x.1" = load i32, i32* %"x"
  ;  Source: printf("%d",x);
  %".78" = call i32 (i8*, ...) @"printf"(i8* %".75", i32 %"x.1")
  ;  Source: x
  %"x.2" = load i32, i32* %"x"
  ;  Source: x++;
  %".81" = load i32, i32* %"x"
  ...
  %".97" = call i32 (i8*, ...) @"printf"(i8* %".93", i32 %"deref_load.9")
  ;  Source: return0;
  ret i32 0
}
