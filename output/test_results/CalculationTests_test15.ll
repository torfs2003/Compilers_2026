...
entry:
  ...
  ;  Source: integer
  %"integer_load.1" = load i32, i32* %"integer"
  ;  Source: integer||6
  %".6" = icmp ne i32 %"integer_load.1", 0
  %".7" = icmp ne i32 6, 0
  %".8" = or i1 %".6", %".7"
  %".9" = zext i1 %".8" to i32
  ...
  ;  Source: integer
  %"integer_load.2" = load i32, i32* %"integer"
  ;  Source: printf("%d",integer);
  %".15" = call i32 (i8*, ...) @"printf"(i8* %".12", i32 %"integer_load.2")
  %"int_ptr" = alloca i32*
  ...
  ;  Source: *int_ptr
  %"deref_load" = load i32, i32* %"int_ptr_load"
  ...
  %"deref_load.1" = load i32*, i32** %"ptr_ptr_load"
  ;  Source: **ptr_ptr
  ...
  ;  Source: int_ptr
  %"int_ptr_load.2" = load i32*, i32** %"int_ptr"
  ;  Source: *int_ptr
  %"deref_load.5" = load i32, i32* %"int_ptr_load.2"
  ;  Source: printf("%d",*int_ptr);
  ...
  ;  Source: *pointer
  %"deref_load.6" = load i32, i32* %"pointer_load"
  ;  Source: printf("%d",*pointer);
  %".55" = call i32 (i8*, ...) @"printf"(i8* %".51", i32 %"deref_load.6")
  %"x" = alloca i32
  %"pointer_load.1" = load i32*, i32** %"pointer"
  %"deref_load.7" = load i32, i32* %"pointer_load.1"
  store i32 %"deref_load.7", i32* %"x"
  %".57" = bitcast [3 x i8]* @"str.7" to i8*
  ;  Source: x
  %"x_load" = load i32, i32* %"x"
  ;  Source: printf("%d",x);
  %".60" = call i32 (i8*, ...) @"printf"(i8* %".57", i32 %"x_load")
  ;  Source: x
  ...
  %"deref_load.8" = load i32*, i32** %"x_ptr_load"
  ;  Source: **x_ptr
