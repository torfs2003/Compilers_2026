...
define void @"reverseCountWithConst"(i32 %".1")
{
entry:
  %"toSkip" = alloca i32
...
entry:
  ...
  ;  Source: toSkip
  %"toSkip_load" = load i32, i32* %"toSkip"
  ;  Source: reverseCountWithConst(toSkip);
  call void @"reverseCountWithConst"(i32 %"toSkip_load")
  ;  Source: toSkip
  ...
  ;  Source: reverseCountWithConst(toSkip);
  call void @"reverseCountWithConst"(i32 %"toSkip_load.2")
  ;  Source: return0;
  ret i32 0
}
