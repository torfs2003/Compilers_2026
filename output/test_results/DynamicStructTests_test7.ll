...
entry:
  ...
  %".14" = call i32 @"getEntry"(%"struct.map"* %"m.2", i8* %".13")
  store i32 %".14", i32* %"v"
  %".16" = bitcast [3 x i8]* @"str.3" to i8*
  ;  Source: v
  %"v.1" = load i32, i32* %"v"
  ;  Source: printf("%d",v);
  %".19" = call i32 (i8*, ...) @"printf"(i8* %".16", i32 %"v.1")
  ;  Source: v
  %"v.2" = load i32, i32* %"v"
  ;  Source: m
  %"m.3" = load %"struct.map"*, %"struct.map"** %"m"
  %".22" = bitcast [6 x i8]* @"str.4" to i8*
  ;  Source: getEntry(m,"lalaw")
  %".24" = call i32 @"getEntry"(%"struct.map"* %"m.3", i8* %".22")
  ;  Source: v=getEntry(m,"lalaw");
  store i32 %".24", i32* %"v"
  %".27" = bitcast [3 x i8]* @"str.5" to i8*
  ;  Source: v
  %"v.3" = load i32, i32* %"v"
  ;  Source: printf("%d",v);
  %".30" = call i32 (i8*, ...) @"printf"(i8* %".27", i32 %"v.3")
  ;  Source: m
  %"m.4" = load %"struct.map"*, %"struct.map"** %"m"
  ;  Source: free(m);
  %".33" = bitcast %"struct.map"* %"m.4" to i8*
...
@"str.2" = internal constant [5 x i8] c"lala\00"
@"str.3" = internal constant [3 x i8] c"%d\00"
@"str.4" = internal constant [6 x i8] c"lalaw\00"
