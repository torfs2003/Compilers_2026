...
entry:
  ...
  store i32 2, i32* %".5"
  %".7" = getelementptr [2 x [2 x i32]], [2 x [2 x i32]]* %"x", i32 0, i32 1
  ...
  %".15" = call i32 (i8*, ...) @"printf"(i8* %".10", i32 %"array_element")
  ...
  %".21" = call i32 (i8*, ...) @"printf"(i8* %".16", i32 %"array_element.1")
  ...
  %".27" = call i32 (i8*, ...) @"printf"(i8* %".22", i32 %"array_element.2")
  ...
  %".33" = call i32 (i8*, ...) @"printf"(i8* %".28", i32 %"array_element.3")
  ;  Source: return0;
  ret i32 0
}
