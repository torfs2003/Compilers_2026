...
entry:
  ...
  %".14" = ptrtoint i32* %"ptr_load.2" to i32
  ...
  %".22" = call i32 (i8*, ...) @"printf"(i8* %".19", i32 %"is_x_load")
  %"is_y" = alloca i32
  %"ptr_load.3" = load i32*, i32** %"ptr"
  %".23" = ptrtoint i32* %"ptr_load.3" to i32
  ...
  %".31" = call i32 (i8*, ...) @"printf"(i8* %".28", i32 %"is_y_load")
  ;  Source: is_y
  ...
  %".37" = ptrtoint i32* %"ptr_load.4" to i32
  ...
  ;  Source: printf("%d",is_y);
  %".45" = call i32 (i8*, ...) @"printf"(i8* %".42", i32 %"is_y_load.2")
  %"ptr2" = alloca float*
  ...
  %".51" = call i32 (i8*, ...) @"printf"(i8* %".48", float* %"ptr2_load")
  ;  Source: return0;
  ret i32 0
}
