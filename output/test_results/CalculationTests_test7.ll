...
entry:
  ...
  ;  Source: printf("%d",a);
  %".18" = call i32 (i8*, ...) @"printf"(i8* %".15", i32 %"a_load.2")
  %"z" = alloca i32
  ...
  ;  Source: printf("%d",z);
  %".26" = call i32 (i8*, ...) @"printf"(i8* %".23", i32 %"z_load")
  ;  Source: x
  ...
  ;  Source: printf("%d",x);
  %".45" = call i32 (i8*, ...) @"printf"(i8* %".42", i32 %"x_load.4")
  ;  Source: a
  ...
  ;  Source: printf("%d",a);
  %".57" = call i32 (i8*, ...) @"printf"(i8* %".54", i32 %"a_load.4")
  %".58" = bitcast [3 x i8]* @"str.4" to i8*
  ;  Source: x
  %"x_load.6" = load i32, i32* %"x"
  ;  Source: printf("%d",x);
  %".61" = call i32 (i8*, ...) @"printf"(i8* %".58", i32 %"x_load.6")
  ;  Source: return0;
  ret i32 0
}
