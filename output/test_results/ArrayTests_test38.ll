...
entry:
  ...
  ;  Source: k
  ;  Source: k+3;
  %".23" = getelementptr [4 x i8], [4 x i8]* %"k", i32 3
  %".24" = bitcast [3 x i8]* @"str.1" to i8*
  ;  Source: k
  ;  Source: (k+2)
  %".27" = getelementptr [4 x i8], [4 x i8]* %"k", i32 2
  ;  Source: *(k+2)
  ;  Source: printf("%c",*(k+2));
  %".30" = getelementptr inbounds [4 x i8], [4 x i8]* %".27", i32 0, i32 0
  %".31" = call i32 (i8*, ...) @"printf"(i8* %".24", i8* %".30")
  ;  Source: return0;
  ret i32 0
}
