...
entry:
  ...
  ;  Source: gouda_ptr
  %"gouda_ptr_load" = load %"struct.cheese"*, %"struct.cheese"** %"gouda_ptr"
  ;  Source: gouda_ptr
  %"gouda_ptr_load.1" = load %"struct.cheese"*, %"struct.cheese"** %"gouda_ptr"
  ...
  %".17" = bitcast %"struct.cheese"* %"gouda_ptr_load.1" to i8*
  ...
  ;  Source: gouda_ptr
  %"gouda_ptr_load.2" = load %"struct.cheese"*, %"struct.cheese"** %"gouda_ptr"
  ;  Source: free(gouda_ptr);
  %".25" = bitcast %"struct.cheese"* %"gouda_ptr_load.2" to i8*
