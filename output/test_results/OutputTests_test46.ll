...
entry:
  ...
  ;  Source: start<end
  %".20" = ptrtoint i32* %"start_load" to i32
  %".21" = ptrtoint i32* %"end_load" to i32
  ...
  ;  Source: end<beyond
  %".30" = ptrtoint i32* %"end_load.1" to i32
  %".31" = ptrtoint i32* %"beyond_load" to i32
  ...
  ;  Source: beyond==arr+3
  %".41" = ptrtoint i32* %"beyond_load.1" to i32
  ...
  ;  Source: beyond>end
  %".51" = ptrtoint i32* %"beyond_load.2" to i32
  %".52" = ptrtoint i32* %"end_load.2" to i32
