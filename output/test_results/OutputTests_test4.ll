...
entry:
  ...
  ;  Source: printf("%d",z);
  %".23" = call i32 (i8*, ...) @"printf"(i8* %".20", i32 %"z_load")
  ;  Source: x
  ...
  ;  Source: printf("%d",x);
  %".42" = call i32 (i8*, ...) @"printf"(i8* %".39", i32 %"x_load.6")
  ;  Source: x
  %"x_load.7" = load i32, i32* %"x"
  ;  Source: --x;
  %".45" = load i32, i32* %"x"
  %".46" = sub i32 %".45", 1
  store i32 %".46", i32* %"x"
  ...
  ;  Source: x
  %"x_load.8" = load i32, i32* %"x"
  ;  Source: printf("%d",x);
  %".51" = call i32 (i8*, ...) @"printf"(i8* %".48", i32 %"x_load.8")
  ;  Source: return0;
  ret i32 0
}
