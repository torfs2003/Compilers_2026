...
entry:
  ...
  %"gep_ptr.3" = getelementptr i32, i32* %"decay_left.3", i32 0
  %"array_element.3" = load i32, i32* %"gep_ptr.3"
  ;  Source: a[0]--;
  %".51" = load i32, i32* %"gep_ptr.3"
  %".52" = sub i32 %".51", 1
  store i32 %".52", i32* %"gep_ptr.3"
  %".54" = bitcast [5 x i8]* @"str.5" to i8*
  ;  Source: a
  ;  Source: a[0]
  %"decay_left.4" = getelementptr [2 x i32], [2 x i32]* %"a", i32 0, i32 0
  %"gep_ptr.4" = getelementptr i32, i32* %"decay_left.4", i32 0
